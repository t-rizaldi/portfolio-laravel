                ...
                <div class="col-lg-8">
                    <div class="post-detail-content">
                        <div class="post-img">
                            ...
                            @else
                                <img src="{{ asset('storage/img_post/default.jpg') }}" alt="Post Image Default" class="img-fluid">
                            @endif
                        </div>
                        <div class="post-info">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card">
                                        @if (!empty($relatedPost->image))
                                            <img src="{{ asset('storage/'.$relatedPost->image) }}" class="card-img-top" alt="...">
                                        @else
                                            <img src="{{ asset('storage/img_post/default.jpg') }}" class="card-img-top" alt="...">
                                        @endif                                        
                                        <div class="card-body">
                                            <p>{{ date('M d, Y', strtotime($relatedPost->created_at)) }}</p>
