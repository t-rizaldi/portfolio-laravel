        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="footer-item">
                    <ul>
                        <li>
                            <a href="{{ route('education') }}" class="footer-item-link">Experience &amp; Education</a>
                        </li>
                        <li>
                            <a href="{{ route('services') }}" class="footer-item-link">Services</a>
                        </li>
                        <li>
                            <a href="{{ route('portfolio') }}" class="footer-item-link">Portfolio</a>
                        </li>
                        <li>
                            <a href="{{ route('blog') }}" class="footer-item-link">Blog</a>
                        </li>
                    </ul>
                </div>
            </div>
